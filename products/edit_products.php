...
<body>    
    ...
    <form action="edit_products_process.php" method="post">
        ...
        <label>Capital</label>
        <input type="number" name="product_capital" required>
        
        <label>Selling Price</label>
        <input type="number" name="product_selling_price" required>

        <input class="buttonSubmit" type="submit" value="Update Product">
    </form>
